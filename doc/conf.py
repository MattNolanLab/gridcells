# -*- coding: utf-8 -*-
#
# Grid cells package documentation build configuration file, created by
...
if on_rtd:
    print('Inside RTD environment! Using Mock objects as modules')
...
exclude_patterns = ['_build', 'src/todo.rst']
...
htmlhelp_basename = 'Gridcellspackagedoc'
...
latex_documents = [
  ('index', 'Gridcellspackage.tex', u'Grid cells package Documentation',
...
man_pages = [
    ('index', 'gridcellspackage', u'Grid cells package Documentation',
     [u'Lukas Solanka'], 1)
]
...
texinfo_documents = [
  ('index', 'Gridcellspackage', u'Grid cells package Documentation',
   u'Lukas Solanka', 'Gridcellspackage', 'One line description of project.',
   'Miscellaneous'),
]
